...
namespace GravadoraStudios.Controllers
{
    public class ResponsaveisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ResponsavelId,Nome,Idade")] Responsavel responsavel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ResponsavelId,Nome,Idade")] Responsavel responsavel)
        {
            if (ModelState.IsValid)
            {
